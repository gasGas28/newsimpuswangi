...
class KunjOnlineController extends Controller
{
    ...
    public function pelayanan($id, $idPoli, $idpelayanan)
    {
        ...
        if ($idPoli == '999') {
            return Inertia::render('Ruang_Layanan/KunjunganOnline/pelayanan', $data);
        } elseif ($idPoli == '008') {
    ...
    public function suketList($idPoli, $idPelayanan)
    {
        ...
        //dd($suketList);
        return Inertia::render('Ruang_Layanan/KunjunganOnline/suratKeterangan', [
            'suketList' => $suketList,
            'idPoli' => $idPoli,
            'idPelayanan' => $idPelayanan
        ]);
    ...
    public function createSuratKeterangan($idPoli, $idPelayanan)
    {
        ...
        // dd($dataAnamnesa);
        return Inertia::render('Ruang_Layanan/KunjunganOnline/SuratKeteranganCreate', [
    ...
    public function editSuket($idPoli, $idPelayanan, $idSurat)
    {
        ...
        $dataAnamnesa = SimpusAnamnesa::with(['loket', 'loket.SimpusPasien.SetupKab', 'loket.SimpusPasien.SetupKel'])->where('loketId', $pelayanan->loketId)->first();
        $TenagaMedisAskep = MasterDokter::whereIn('profesi_id', [19, 20])->where('aktif', 1)->get();
        return Inertia::render('Ruang_Layanan/KunjunganOnline/SuratKeteranganUpdate', [
            'jenisSurat' => $jenisSurat,
            'idPoli' => $idPoli,
            'idPelayanan' => $idPelayanan,
            'dataAnamnesa' => $dataAnamnesa,
    ...
    public function formLaborat(Request $request, $idPoli, $idLoket, $idPelayanan)
    {
        ...
        $TenagaMedisAskep = MasterDokter::whereIn('profesi_id', [19, 20])->where('aktif', 1)->get();
        return Inertia::render('Ruang_Layanan/KunjunganOnline/formLaborat', [
            'Pelayanan' => $Pelayanan,
            'Pasien' => $Pasien,
            'tenagaMedisAskep' => $TenagaMedisAskep
        ]);
    ...
    public function riwayatPasien($idPoli, $idPasien)
    {
        ...
        // dd($riwayatPasien);
        return Inertia::render('Ruang_Layanan/KunjunganOnline/riwayatPasien', [
