...
<template>
  <div class="card shadow-sm border-0">
    <div class="card-header bg-white text-dark fw-bold fs-5 border-bottom">MAL SEHAT</div>
    <div class="card-body bg-light-subtle p-3">
      <div class="row g-3">
        <div class="col-12 col-sm-6 col-lg-4" v-for="item in layanan" :key="item.nama">
          <div
