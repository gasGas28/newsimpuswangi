    ...
    <AppLayout>
        <div class="container py-4">
            ...
            >
                ...
                >
                    <img
                        src="https://upload.wikimedia.org/wikipedia/commons/3/36/Coat_of_arms_of_Banyuwangi_Regency.svg"
                        alt="Banyuwangi"
                        height="60"
                    ...
                    <div class="w-100 text-center">
                        ...
                        <div class="fw-bold" style="font-size: 13px">
                            Jl. Letkol Istiqlah No.40 Banyuwangi Telepon (0333)
                            429444
                        </div>
                        <div style="font-size: 13px">
                            Email: labkesdabanyuwangi@gmail.com
                        </div>
                    </div>
                    <img
                        src="https://upload.wikimedia.org/wikipedia/commons/9/98/Emblem_of_Ministry_of_Health_of_the_Republic_of_Indonesia.svg"
                        alt="Kemenkes"
                        height="60"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowspan="5">
                                    ...
                                    <p class="mb-1">
                                        Manajemen CV. Permata Bogania Nusantara
                                    </p>
                                    <p class="mb-1">
                                        Perum Mendut Regency Blok I-5
                                    </p>
                                    <p class="mb-1">
                                        Kelurahan Mojopanggung, Kec. Giri
                                    </p>
                ...
                <div class="mt-3">
                    <p>
                        Disampaikan dengan hormat hasil pemeriksaan Laboratorium
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="6" class="small">
                                <h6
                                    class="text-decoration-underline fw-bold ps-2"
                                >
                                    REKOMENDASI
                                </h6>
                                <ul class="mt-2">
                                    <li>
                                        Terima kasih atas peran aktifnya dalam
                                        pengawasan kualitas makanan di
                                        lingkungan restoran yang saudara kelola.
                                    </li>
                                    <li>
                                        Hasil analisa menunjukkan TIDAK
                                        MENGANDUNG bakteri
                                        <em>Salmonella sp</em>,
                                        <em>E. coli</em>,
                                    ...
                                    <li>
                                        Inspeksi sanitasi dan kebersihan tetap
                                        dilakukan secara berkala.
                                    </li>
                                    <li>
                                        Pemeriksaan minimal setiap 6 bulan atau
                                        sesuai ketentuan.
                                    </li>
                                </ul>
                            </td>
                ...
                <div class="small">
                    <p>
                        ...
                        Demikian hasil analisa laboratorium kami, untuk dapat
                ...
                <div class="row small mt-2">
                    ...
                    <div class="col-md-6">
                        <div
                            class="border border-black border-1 p-3 rounded"
                            style="font-size: 13px"
                        >
                            <strong>PERHATIAN :</strong><br />
                            Hasil pengujian ini hanya berlaku pada contoh di
                            atas<br />
                            Lembar ini
                ...
                <div class="small mt-4">
                    ...
                    <ol class="mt-2 ps-3">
                        <li>
                            Sub Koordinator Kesehatan Lingkungan Kesehatan Kerja
                            & Olahraga
