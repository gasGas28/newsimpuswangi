<template>
  <AppLayouts>
    <div class="card m-4  rounded-4 rounded-bottom-0">
      ...
      <div class="card-body">
        <PelayananPasien @ubah-melayani="isMelayani = $event" :dataPasien="DataPasien"
          ...
          <div class="shadow-sm rounded-5">
            ...
            <div class="m-4 pb-4 row gx-5">
              <FormPelayananSubjective v-if="currentTab === 'subjective'" :idLoket="DataPasien.idLoket"
                :dataAnamnesa="DataAnamnesa" :masterAlergi="MasterAlergi">
              </FormPelayananSubjective>
              <FormPelayananObjective v-if="currentTab === 'objective'" :currrentSub=true halaman="umum"
                :dataKesadaran="DataKesadaran" :dataAnamnesa="DataAnamnesa">
              </FormPelayananObjective>
              <FormPelayananAssesment v-if="currentTab === 'assesment'" :diagnosaKasus="DiagnosaKasus" :dataPasien ="DataPasien">
...
const { props } = usePage();
const DataPasien = props.DataPasien[0];
...
console.log('ini data pasien dari pelayanan umum', DataPasien);
console.log(DataPasien.idLoket)
console.log('data alergi',MasterAlergi)
</script>
