<template>
    <div class="container surat p-3">
        ...
        <div class="row align-items-center text-center mb-2">
            ...
            <div class="col-8">
                <h5 class="mb-0 fw-bold">PEMERINTAH KABUPATEN BANYUWANGI</h5>
                <h5 class="mb-0 fw-bold">DINAS KESEHATAN</h5>
                <h5 class="mb-0 fw-bold">{{ unit.nama_unit }}</h5>
        ...
        <div class="text-center my-2">
            <h6 class="fw-bold text-decoration-underline mb-1">SURAT KETERANGAN DOKTER</h6>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <table style="border-collapse: collapse;" class="ms-2">
                            <tr>
        ...
        <!-- Data Pemeriksaan -->
        <h6 class="fw-bold text-decoration-underline mt-3">Data Pemeriksaan</h6>
        ...
        <!-- Penutup -->
        <p class="mb-2 mt-2">
            Setelah kami lakukan pemeriksaan dengan seksama, yang bersangkutan pada saat ini kami nyatakan dalam
            kondisi:
            <strong class="text-uppercase">{{ suket.hasil_pemeriksaan }}</strong>, sehingga membutuhkan istirahat selama
            {{ selisihHari(suket.tgl_ijin_awal, suket.tgl_ijin_akhir) }} hari terhitung mulai tanggal
            {{ formatDate(suket.tgl_ijin_awal) }} s/d {{ formatDate(suket.tgl_ijin_akhir) }}.
        </p>
