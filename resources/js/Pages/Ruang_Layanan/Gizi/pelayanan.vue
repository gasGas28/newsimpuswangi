  ...
  <AppLayouts>
    <div class="card m-4  rounded-4 rounded-bottom-0">
      <div class="card-header bg-info d-flex justify-content-between p-3  rounded-4 rounded-bottom-0"
        ...
        <h1 class="fs-5 text-white">GIZI</h1>
      ...
      <div class="card-body">
        <PelayananPasien @ubah-melayani="isMelayani = $event" :dataPasien="DataPasien" :dataAnamnesa="DataAnamnesa"
          ...
          <div class="shadow-sm rounded-5">
            <NavigasiFormPemeriksaan :currentTab="currentTab" @change-currentTab="currentTab = $event" :kdPoli="idPoli">
            ...
            <div class="m-4 pb-4 row gx-5">
              ...
              <FormPelayananGizi  v-if="currentTab === 'Gizi'" :dataAnamnesa="DataAnamnesa" :dataPasien="DataPasien" :TenagaMedisAskep="TenagaMedisAskep" :gizi="gizi">
              </FormPelayananGizi>
...
const gizi =computed(() => page.props.gizi);
