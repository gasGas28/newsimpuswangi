<template>
  <section class="resume-panel">
    <div class="panel-header">
      <div>
        <h4><i class="bi bi-clipboard2-check"></i> Data Tindakan</h4>
        <p>Status pengisian dan rangkuman data utama sebelum dikirim ke SATUSEHAT.</p>
      </div>
    </div>

    <div class="panel-body">
    <div v-for="tindakan in props.DataTindakan" :key="tindakan.kdTindakan">
        <div class="summary-grid">
        <div class="summary-item">
          <div class="summary-label">Kode Tindakan</div>
          <div class="summary-value">{{ tindakan.kdTindakan }}</div>
        </div>
        <div class="summary-item">
          <div class="summary-label">Nama Tindakan</div>
          <div class="summary-value">{{ tindakan.nmTindakan }} CM</div>
        </div>
        <div class="summary-item">
          <div class="summary-label">Nama Tindakan Indonesia </div>
          <div class="summary-value">{{ tindakan.nmTindakanInd }}</div>
        </div>
        <div class="summary-item">
          <div class="summary-label">Keterangan</div>
          <div class="summary-value">{{ tindakan.keterangan }}</div>
        </div>
      </div>
    </div>
