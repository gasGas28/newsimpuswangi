<template>
  <div class="resume-form">
    ...
    <div class="send-tab-content">
      ...
      <SendHipertensi
        v-if="selectedForm === 'Hipertensi'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendObesitas
        v-if="selectedForm === 'Obesitas'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendDiabetes
        v-if="selectedForm === 'Diabetes'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendAsamUrat
        v-if="selectedForm === 'AsamUrat'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendProfilLipid
        v-if="selectedForm === 'ProfilLipid'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendPendengaran
        v-if="selectedForm === 'Pendengaran'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendPenglihatan
        v-if="selectedForm === 'Penglihatan'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendKankerParu
        v-if="selectedForm === 'KankerParu'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendKolorektal
        v-if="selectedForm === 'Kolorektal'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendKankerServiks
        v-if="selectedForm === 'KankerServiks'"
        :DataPasien="props.DataPasien"
        :TenagaMedis="props.TenagaMedis"
        :DataSkrining="props.DataSkrining"
      />
      <SendEKG
        v-if="selectedForm === 'EKG'"
        :DataPasien="props.DataPasien"
      />
      <SendThalasemia
        v-if="selectedForm === 'Thalasemia'"
        :DataPasien="props.DataPasien"
      />
    </div>
  </div>
...
<script setup>
  ...
  import SendThalasemia from '../KirimSatuSehat/KirimThalasemia.vue';
  ...
  const tabs = [
    ...
    { value: 'Thalasemia', label: 'Thalasemia', icon: 'bi-gender-pulse' },
