  ...
  <div class="card">
    <div class="card-header bg-purple text-white">
      ...
      <h5 class="card-title mb-0 text-center">
        Grafik Tinggi Badan Anak {{ jenisKelamin === 'laki' ? 'Laki-laki' : 'Perempuan' }} (Usia
        24–60 Bulan)
      </h5>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="text-center mt-4">
        <button @click="tambahData" class="btn btn-purple btn-lg px-5">Simpan</button>
        <button
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <tr v-for="(item, index) in dataAnak" :key="index">
                ...
                <td>
                  <button @click="hapusData(index)" class="btn btn-sm btn-danger">Hapus</button>
                </td>
              </tr>
            </tbody>
          </table>
...
<script setup>
  ...
  const formData = ref({ tanggal: '', umur: '', tinggiBadan: '' });
  const dataAnak = ref([]);
  ...
  const dataStandarLaki = {
    ...
    median: [
      87.8, 88.7, 89.6, 90.4, 91.2, 92.0, 92.8, 93.5, 94.3, 95.0, 95.7, 96.4, 97.1, 97.7, 98.4,
      99.0, 99.7, 100.3, 100.9, 101.5, 102.1, 102.7, 103.3, 103.9, 104.4, 105.0, 105.6, 106.1,
      106.7, 107.2, 107.8, 108.3, 108.9, 109.4, 109.9, 110.5, 111.0,
    ],
    plus3sd: [
      93.9, 94.9, 95.8, 96.7, 97.6, 98.5, 99.3, 100.1, 100.9, 101.7, 102.5, 103.3, 104.0, 104.8,
      105.5, 106.2, 106.9, 107.6, 108.3, 109.0, 109.7, 110.4, 111.0, 111.7, 112.3, 113.0, 113.6,
      114.3, 114.9, 115.5, 116.1, 116.8, 117.4, 118.0, 118.6, 119.2, 119.8,
    ],
    plus2sd: [
      90.6, 91.6, 92.5, 93.4, 94.3, 95.1, 95.9, 96.7, 97.5, 98.3, 99.1, 99.8, 100.6, 101.3, 102.0,
      102.7, 103.4, 104.1, 104.8, 105.5, 106.1, 106.8, 107.4, 108.1, 108.7, 109.4, 110.0, 110.6,
      111.2, 111.9, 112.5, 113.1, 113.7, 114.3, 114.9, 115.5, 116.1,
    ],
    minus2sd: [
      81.7, 82.5, 83.4, 84.2, 85.0, 85.7, 86.5, 87.2, 87.9, 88.6, 89.3, 90.0, 90.7, 91.3, 92.0,
      92.6, 93.2, 93.8, 94.4, 95.0, 95.6, 96.2, 96.8, 97.3, 97.9, 98.5, 99.0, 99.6, 100.1, 100.7,
      101.2, 101.8, 102.3, 102.8, 103.4, 103.9, 104.4,
    ],
    minus3sd: [
      78.7, 79.5, 80.3, 81.1, 81.9, 82.6, 83.4, 84.1, 84.8, 85.5, 86.2, 86.8, 87.5, 88.1, 88.8,
      89.4, 90.0, 90.6, 91.2, 91.8, 92.4, 93.0, 93.5, 94.1, 94.6, 95.2, 95.7, 96.3, 96.8, 97.4,
      97.9, 98.4, 98.9, 99.5, 100.0, 100.5, 101.0,
    ],
  };

  // 📊 Data Standar WHO Perempuan
  const dataStandarPerempuan = {
    ...
    median: [
      86.4, 87.3, 88.1, 88.9, 89.7, 90.4, 91.2, 91.9, 92.6, 93.3, 94.0, 94.6, 95.3, 95.9, 96.6,
      97.2, 97.8, 98.4, 99.0, 99.6, 100.2, 100.7, 101.3, 101.9, 102.4, 103.0, 103.5, 104.1, 104.6,
      105.1, 105.7, 106.2, 106.7, 107.2, 107.7, 108.2, 108.7,
    ],
    plus3sd: [
      92.9, 93.9, 94.8, 95.7, 96.6, 97.4, 98.3, 99.1, 99.9, 100.7, 101.5, 102.2, 103.0, 103.7,
      104.5, 105.2, 105.9, 106.6, 107.3, 108.0, 108.7, 109.3, 110.0, 110.6, 111.3, 111.9, 112.5,
      113.2, 113.8, 114.4, 115.0, 115.7, 116.3, 116.9, 117.5, 118.1, 118.7,
    ],
    plus2sd: [
      89.6, 90.5, 91.4, 92.3, 93.1, 94.0, 94.8, 95.6, 96.4, 97.2, 97.9, 98.7, 99.4, 100.2, 100.9,
      101.6, 102.3, 103.0, 103.7, 104.3, 105.0, 105.6, 106.3, 106.9, 107.5, 108.2, 108.8, 109.4,
      110.0, 110.6, 111.2, 111.8, 112.4, 113.0, 113.6, 114.2, 114.8,
    ],
    minus2sd: [
      80.0, 80.8, 81.7, 82.5, 83.2, 84.0, 84.7, 85.4, 86.1, 86.8, 87.5, 88.1, 88.8, 89.4, 90.1,
      90.7, 91.3, 91.9, 92.5, 93.1, 93.6, 94.2, 94.8, 95.3, 95.9, 96.4, 97.0, 97.5, 98.1, 98.6,
      99.1, 99.7, 100.2, 100.7, 101.2, 101.7, 102.2,
    ],
    minus3sd: [
      76.7, 77.5, 78.4, 79.1, 79.9, 80.6, 81.3, 82.0, 82.7, 83.4, 84.0, 84.7, 85.3, 85.9, 86.6,
      87.2, 87.8, 88.4, 89.0, 89.6, 90.1, 90.7, 91.3, 91.8, 92.4, 92.9, 93.5, 94.0, 94.5, 95.1,
      95.6, 96.1, 96.6, 97.1, 97.6, 98.1, 98.6,
    ],
  };

  // Gunakan data standar sesuai jenis kelamin
  const dataStandarAktif = computed(() =>
    jenisKelamin.value === 'laki' ? dataStandarLaki : dataStandarPerempuan
  );
  ...
  watch(jenisKelamin, buatGrafik);
  onMounted(buatGrafik);
</script>
